    ...
    >
      ...
      <View className="bg-black/20 self-stretch items-center pb-6 border border-white/10 mx-3 rounded-2xl -mt-5">
        <ImageBackground
          ...
          className="px-6 py-5 h-40 items-center self-stretch border-b border-white/10 overflow-hidden"
        >
        ...
        {data.image ? (
          ...
          <TouchableOpacity
            ...
            className="w-36 h-36 rounded-full bg-gray-400 items-center justify-center -mt-28"
          >
